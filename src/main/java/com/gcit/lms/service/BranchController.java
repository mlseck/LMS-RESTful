...
public class BranchController {
	...
	@Transactional
	@RequestMapping(value = "/branch/save", method = RequestMethod.POST, consumes="application/json")
	...
	@RequestMapping(value = "/branch/delete", method = RequestMethod.POST, consumes="application/json")
	public void deleteBranch(@RequestBody Branch branch) throws SQLException{
		brdao.deleteBranch(branch);
	}
	
	@RequestMapping(value = "/branch/getCount", method = RequestMethod.GET, produces="application/json")
	public Integer getBranchesCount() throws SQLException {
		return brdao.getBranchesCount();
	}
	
	@RequestMapping(value = "/branch/getBranches/{pageNo}/{searchString}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/branch/getByID/{branchId}", method = RequestMethod.GET, produces="application/json")
	public Branch getBranchById(@PathVariable Integer branchId) throws SQLException{
		return brdao.getBranchByPK(branchId);
	}
	
	@RequestMapping(value = "/branch/addBook", method = RequestMethod.POST, consumes="application/json")
	public void addBookCopyToBranch(@RequestBody BookCopies bc) throws SQLException {
		bcdao.addBookCopies(bc);
	}
	
	@RequestMapping(value = "/branch/addBooks", method = RequestMethod.POST, consumes="application/json")
	...
	@RequestMapping(value = "/branch/updateBook", method = RequestMethod.POST, consumes="application/json")
	public void updateBookCopies(@RequestBody BookCopies bc) throws SQLException {
		bcdao.updateBookCopies(bc);
	}
	
	@RequestMapping(value = "/branch/getBooks/{branchId}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/branch/getBookCopies/{branchId}", method = RequestMethod.GET, produces="application/json")
	public List<BookCopies> getBookCopiesInBranch(@PathVariable Integer branchId)
			throws SQLException {
		return bcdao.getBookCopiesByBranchId(branchId);
	}
	
	@RequestMapping(value = "/branch/getBookCopyByPk/{branchId}/{bookId}", method = RequestMethod.GET, produces="application/json")
